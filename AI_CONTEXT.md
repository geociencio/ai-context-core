...
- **Total Modules**: 49
- **Source Lines (SLOC)**: 1,331
- **Total Physical Lines**: 2,393
- **Functions**: 107
- **Classes**: 27
- **Average Complexity**: 3.7
- **Avg Maintenance Index**: 70.0
...
- `src/ai_context_core/analyzer/fs_utils.py` (19 commits)
### Recent Churn (30 days):
- Total lines changed: 128196
