...
### .agent/scripts/skill_sync.py
- **functions_too_long**: Very long functions (average 67.5 lines/function).

### src/ai_context_core/analyzer/metrics.py
- **functions_too_long**: Very long functions (average 62.8 lines/function).

### src/ai_context_core/analyzer/dependencies.py
- **complexity_refactoring**: High complexity (52) with several functions. Consider breaking down large logic.

### src/ai_context_core/analyzer/engine.py
- **complexity_refactoring**: High complexity (29) with several functions. Consider breaking down large logic.
- **module_too_large**: Module is quite large (420 lines)

### src/ai_context_core/analyzer/fs_utils.py
- **complexity_refactoring**: High complexity (52) with several functions. Consider breaking down large logic.
- **module_too_large**: Module is quite large (448 lines)
