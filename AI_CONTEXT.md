...
### PROJECT_WIDE
- **Opt**: Project Quality Score (69.4/100) has room for improvement. Target complexity reduction.
### .agent/scripts/benchmark.py
- **functions_too_long**: Very long functions (average 55.0 lines/function).
