...
- **Most Complex Modules**: src/ai_context_core/analyzer/fs_utils.py, src/ai_context_core/cli.py, src/ai_context_core/analyzer/ast_qgis.py
...
- Total lines changed: 77762

## 🔑 PROJECT KEYWORDS
- **Technologies**: .md, .py, .json, .yaml, .yml, .toml, .in, .zip