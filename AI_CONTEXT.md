...
- **src/ai_context_core/config/loader.py**: CBO 12 (In: 12, Out: 0)
- **src/ai_context_core/analyzer/engine.py**: CBO 11 (In: 11, Out: 0)
...
- Total lines changed: 244627

## 🔑 PROJECT KEYWORDS
- **Technologies**: .py, .md, .json, .yml, .toml, .yaml, .txt, .in